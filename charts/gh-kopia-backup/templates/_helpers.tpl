...
*/}}
{{- define "gh-kopia-backup.name" -}}
{{- default "gh-kopia-backup" .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
*/}}
{{- define "gh-kopia-backup.fullname" -}}
{{- if .Values.fullnameOverride }}
{{- .Values.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default "gh-kopia-backup" .Values.nameOverride }}
